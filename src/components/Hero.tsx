  ...
  return (
    ...
    <div className="content-section">
      ...
      <p className="description">
        A curated AI marketplace that now empowers you with all the tools and resources you need to transform your
        profession, accelerate performance, and deliver impactful value.
      </p>
